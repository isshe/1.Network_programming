...
void tu8_22dg_echo(int sockfd, SA *pcliaddr, socklen_t clilen)
{
	socklen_t 	len;
	char 		msg[MAXLINE];
	int 		n = 0;
...
//	n = 1000 * 1024;
//	my_setsockopt(sockfd, SOL_SOCKET, SO_RCVBUF, &n, sizeof(n));
...
int main(int argc, char **argv)
{
    ...
    tu8_22dg_echo(sockfd, (SA *) &cliaddr, sizeof(cliaddr));
    return 0;
}
